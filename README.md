...
**Описание:** Найти максимальный элемент в массиве целых чисел без знака и сохранить результат в аккумуляторе (ACC). Алгоритм поддерживает массивы размером от 1 до 15 элементов.
...
**Ожидаемый результат:** `70` (максимальный элемент в аккумуляторе ACC)
...
**Алгоритм:**
1. Инициализация: первый элемент становится начальным максимумом
...
4. Цикл: пока индекс <= размер
   ...
   - Увеличение индекса
5. Результат в ACC (максимальный элемент)
...
- **Для задачи 1:** отображение массива данных (0x0100-0x0107) и значения аккумулятора (ACC)
